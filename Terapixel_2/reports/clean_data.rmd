...
Whilist I probably wont use date in my investigation I did it to make sure that there where no errors in time recording (i.e a time belonding to a diffrent day appered in this test). Doing a count on Dates showed that all timestamp belong to 2018-11-08	
